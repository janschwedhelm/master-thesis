""" Trains a VAE for the MNIST task """
...
def main(args):
    ...
    # Load model
    model = MnistBinVAE(args)
    if hparams.load_from_checkpoint is not None:
        model = MnistBinVAE.load_from_checkpoint(hparams.load_from_checkpoint)
...
if __name__ == "__main__":
    ...
    parser = MnistBinVAE.add_model_specific_args(parser)
