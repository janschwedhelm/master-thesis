""" Trains a VQ-VAE2 for the CelebA task """
...
def main(args):
    # Load model
    model = CelebaVQVAE2(args)
    if hparams.load_from_checkpoint is not None:
        model = CelebaVQVAE2.load_from_checkpoint(hparams.load_from_checkpoint)
...
if __name__ == "__main__":
    ...
    parser = CelebaVQVAE2.add_model_specific_args(parser)
    ...
    utils.add_default_trainer_args(parser, default_root="logs/train/CelebaVQVAE2")
