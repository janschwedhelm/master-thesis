...
from src.celeba.celeba_pixelcnn import GatedPixelCNN
...
def main(args):
    # Load model
    model = GatedPixelCNN(args)
    if hparams.load_from_checkpoint is not None:
        model = GatedPixelCNN.load_from_checkpoint(hparams.load_from_checkpoint)
...
if __name__ == "__main__":
    ...
    parser = GatedPixelCNN.add_model_specific_args(parser)
    ...
    utils.add_default_trainer_args(parser, default_root="logs/train/CelebaPixelCNN")
