...
from weighted_retraining.celeba_obj_function import *
...
def entmoot_train_opt(
    ...
    while _n_calls > 0:
        ...
        if batch_size is not None:
            ...
            #print(f"Start optimization of acquisition function for iteration {itr}")
            start_time = time.time()
            ...
            #print(f"Optimization procedure for iteration {itr} took {end_time - start_time:.1f}s to finish")
            LOGGER.info(f"Suggested sample: {next_x}")
            #print(f"Suggested sample: {next_x}")
        ...
        #print(f"Refitting model took {end_time - start_time:.1f}s to finish")
    ...
    if verbose > 0:
        ...
        #print("SOLVER: finished retraining iteration!")
