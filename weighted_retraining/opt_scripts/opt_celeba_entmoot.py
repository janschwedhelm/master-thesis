...
from weighted_retraining.celeba.celeba_vqvae_64 import CelebaVQVAE
...
from weighted_retraining import ENTMOOT_TRAIN_OPT_FILE
...
def main_loop(args):
    ...
    model = CelebaVQVAE.load_from_checkpoint(args.pretrained_model_file)
