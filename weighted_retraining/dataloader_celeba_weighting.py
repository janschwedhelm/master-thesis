...
from weighted_retraining.dataloader_celeba_classifier import *
...
class CelebaWeightedTensorDataset(pl.LightningDataModule):
    ...
    def __init__(self, hparams, data_weighter):
        ...
        #self.property_id_2 = hparams.property_id_2
    ...
    def add_model_specific_args(parent_parser):
        ...
        #    type=int,
        #    default=None,
        #    help="Second attribute id of object property",
        #)
        data_group.add_argument(
            "--max_property_value",
            type=int,
    ...
    def val_dataloader(self):
        #if self.mode == "all":
        #    raise AttributeError("No validation loader available if 'all' is chosen as mode.")
        return DataLoader(
            self.val_dataset,
            batch_size=self.batch_size,
            num_workers=NUM_WORKERS,
