...
from weighted_retraining.torch_mimicry.nets.basemodel import basemodel
from weighted_retraining.torch_mimicry.modules import losses
...
class BaseGenerator(basemodel.BaseModel):
    ...
    def train_step(self,
        ...
        # Produce fake images
        fake_images, _ = self.generate_images(num_images=batch_size,
                                              device=device)
...
class BaseDiscriminator(basemodel.BaseModel):
    ...
    def train_step(self,
        ...
        # Produce fake images
        fake_images, _ = netG.generate_images(num_images=batch_size,
                                              device=device)
