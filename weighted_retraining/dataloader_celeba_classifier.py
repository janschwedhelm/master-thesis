...
from weighted_retraining.utils import rounddown
...
class CelebA(data.Dataset):
    ...
    def __init__(self, filename_set_path, data_dir, attr_path, mode, attribute_id=None, max_property_value=5):
        ...
        #self.attribute_id_2 = attribute_id_2
    ...
    def preprocess(self):
        ...
        for i, line in enumerate(lines):
            ...
            if self.attribute_id is not None:
                #if self.attribute_id_2 is not None:
                #    targets = targets[[self.attribute_id, self.attribute_id_2]]
                #else:
